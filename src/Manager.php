...
use Wenprise\SessionManager\Handlers\BaseHandler;
...
class Manager implements \SessionHandlerInterface {
	 ...
	 *
	 * @param \Wenprise\SessionManager\Interfaces\HandlerInterface $handler
	 *
	 * @return static
	 */
	public function addHandler( $handler ) {
		...
		{
			return call_user_func( [ $handler, 'delete' ], $session_id, $next_delete );
		};
		...
		{
			return call_user_func( [ $handler, 'clean' ], $lifetime, $next_clean );
		};
		...
		{
			return call_user_func( [ $handler, 'create' ], $path, $name, $next_create );
		};
		...
		{
			return call_user_func( [ $handler, 'read' ], $session_id, $next_read );
		};
		...
		{
			return call_user_func( [ $handler, 'write' ], $session_id, $session_data, $next_write );
		};
